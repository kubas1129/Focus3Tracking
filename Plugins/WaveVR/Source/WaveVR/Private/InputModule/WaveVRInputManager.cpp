	...
	, m_Player(nullptr)
{
	...
	ControllerTransformR = CreateDefaultSubobject<USceneComponent>(TEXT("ControllerTransformR"));
	...
	ControllerTransformL = CreateDefaultSubobject<USceneComponent>(TEXT("ControllerTransformL"));
	...
	HandTransformR = CreateDefaultSubobject<USceneComponent>(TEXT("HandTransformR"));
	//HandTransformR = NewObject<USceneComponent>(this, TEXT("HandTransformR"));
	HandTransformR->SetupAttachment(VRCameraRoot);

	HandTransformL = CreateDefaultSubobject<USceneComponent>(TEXT("HandTransformL"));
	 ...
	 *     |  |-- HandModelL
	 **/
	GazeInput = CreateDefaultSubobject<UWaveVRGazePointer>(TEXT("GazeInput"));
	//GazeInput = NewObject<UWaveVRGazePointer>(this, TEXT("GazeInput"));
	GazeInput->SetupAttachment(VRCamera);

	ControllerInputR = CreateDefaultSubobject<UWaveVRControllerPointer>(TEXT("ControllerInputR"));
	...
	ControllerModelR = CreateDefaultSubobject<UWaveVRControllerModel>(TEXT("ControllerModelR"));
	...
	ControllerInputL = CreateDefaultSubobject<UWaveVRControllerPointer>(TEXT("ControllerInputL"));
	...
	ControllerModelL = CreateDefaultSubobject<UWaveVRControllerModel>(TEXT("ControllerModelL"));
