...
public:
	...
	void SetFoveationParams(const int32 ViewIndex, const WVR_RenderFoveationParams_t& FoveatParams);
	...
	void GetFoveationParams(const int32 ViewIndex, WVR_RenderFoveationParams_t& FoveatParams) const;
