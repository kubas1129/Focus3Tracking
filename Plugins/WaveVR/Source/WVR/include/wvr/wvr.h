 ...
 * @deprecated The WVR_SupportedFeature_PassthroughImage deprecated in Wave SDK 4.0.0
 */
typedef enum {
 ...
 *
 * @return Retrieves the runtime version. It is considered an error if the returned value is 0.
 * @version API Level 1
 */
 ...
 *
 * @return Retrieves the SDK version. It is considered an error if the returned value is 0.
 * @version API Level 1
 */
...
/**
 * @brief Function to get if a feature is supportted
 *
 * This API can work before or after invoking WVR_Init
 * @return The bitmask of all the supported features
 * @version API Level 5
 */
