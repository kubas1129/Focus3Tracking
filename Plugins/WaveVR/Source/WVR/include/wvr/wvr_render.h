...
typedef enum {
    ...
    WVR_RenderConfig_sRGB                          = ( 1 << 2 ),    /**< **WVR_RenderConfig_sRGB**: To do gamma correction for a linear space source. */
    WVR_RenderConfig_GL_No_Error                   = ( 1 << 3 ),    /**< **WVR_RenderConfig_GL_No_Error**: Apply GL_KHR_no_error extension to enable OpenGL no error mode. */
    WVR_RenderConfig_Initialize_FadeOut            = ( 1 << 5 ),    /**< **WVR_RenderConfig_Initialize_FadeOut**: Initialize fade out feature, it will take gpu usage for polling state. */
    WVR_RenderConfig_Initialize_UMC                = ( 1 << 6 ),    /**< **WVR_RenderConfig_Initialize_UMC**: Initialize UMC feature, it will take gpu usage for polling state. */
    WVR_RenderConfig_Initialize_PMC                = ( 1 << 7 ),    /**< **WVR_RenderConfig_Initialize_PMC**: Initialize PMC feature, it will take gpu usage for polling state.*/
    WVR_RenderConfig_Initialize_FrameSharpnessEnhancement = ( 1 << 8 ),    /**< **WVR_RenderConfig_Initialize_FrameSharpnessEnhancement**: Initialize frame sharpness enhancement, it will force enable 2-stage pipeline and take gpu usage for polling state.*/
 ...
 *
 * WVR_SubmitFrame needs this flag to specify the invoking path.
 * Currently, the default functionality is available for the runtime to submit the texture target process.
 * To do distortion correction, apply the flag WVR_SubmitExtend_DisableDistortion in this invoking path.
 * The flag WVR_SubmitExtend_PartialTexture should be applied when presenting a cropped texture.
 * The cropped range of the texture is determined by the WVR_TextureLayout struct in WVR_TextureParams.
 */
typedef enum {
    WVR_SubmitExtend_Default = 0x0000,                      /**< **WVR_SubmitExtend_Default**: The default process to submit the texture to the display. */
    WVR_SubmitExtend_DisableDistortion = 0x0001,            /**< **WVR_SubmitExtend_DisableDistortion**: The render runtime doesn't correct distortion for this submit. */
    WVR_SubmitExtend_PartialTexture = 0x0010,               /**< **WVR_SubmitExtend_Partial**: Present the partial texture.*/
    WVR_SubmitExtend_SystemReserved1 = 1 << 30              /**< **Reserved for the system.*/
} WVR_SubmitExtend;

/**
 * @brief Enumerate to specify the flag of the corresponding texture layer.
 *
 * WVR_LayerParams_t This flag is needed to specify the invoking path.
 */
typedef enum {
    WVR_TextureOption_None           = 0,                   /**< **WVR_TextureOption_None**: The default option. The current layer is worldlock and treated as transparent. */
    WVR_TextureOption_HeadLocked     = 1 << 0,              /**< **WVR_TextureOption_HeadLocked**: Texture layer is headlock. Avoid runtime to apply reprojection on this layer. */
    WVR_TextureOption_Opaque         = 1 << 1,              /**< **WVR_TextureOption_Opaque**: The texture layer is opaque. */
} WVR_TextureOptions;
 ...
 */
typedef enum {
    WVR_TextureLayerType_Content  = 0,      /**< **WVR_TextureLayerType_Content**: Content type*/
    WVR_TextureLayerType_Overlay  = 1,      /**< **WVR_TextureLayerType_Overlay**: Overlay type*/
    WVR_TextureLayerType_Underlay = 2,      /**< **WVR_TextureLayerType_Underlay**: Underlay type*/
} WVR_TextureLayerType;

/**
 * @brief The shape of the texture.
 *
 * Enumerate the shape of the texture.
 */
typedef enum {
    WVR_TextureShape_Quad       = 0,      /**< **WVR_TextureShape_Quad**: Quad shape*/
    WVR_TextureShape_Cylinder   = 1,      /**< **WVR_TextureShape_Cylinder**: [Experimental feature] Cylindrical shape*/
} WVR_TextureShape;
...
typedef enum {
    WVR_AMCMode_Off       = 0,     /**< **WVR_AMCMode_Off**: Disable all AMC feature. Default mode.*/
    WVR_AMCMode_Force_UMC = 1,     /**< **WVR_AMCMode_Force_UMC**: UMC always on and disable PMC.*/
    WVR_AMCMode_Auto      = 2,     /**< **WVR_AMCMode_Auto**: AMC will dynamicly turn on or off UMC/PMC based on rendering and performance status.*/
    WVR_AMCMode_Force_PMC = 3,     /**< **WVR_AMCMode_Force_PMC**: PMC always on and disable UMC. Avaliable when depth texture is submited.*/
} WVR_AMCMode;


/**
 * @brief Time Warp Stabilized mode
 *
 * Enumerate mode for time warp stabilized mode.
 */
typedef enum {
    WVR_TimeWarpStabilizedMode_Off  = 0, /**< **WVR_TimeWarpStabilizedMode_Off** : Disable time warp stabilized mode.*/
    WVR_TimeWarpStabilizedMode_On   = 1, /**< **WVR_TimeWarpStabilizedMode_On** : Always enable time warp stabilized mode.*/
    WVR_TimeWarpStabilizedMode_Auto = 2, /**< **WVR_TimeWarpStabilizedMode_Auto** : Auto enable and disable time warp stabilized mode when APP exeuting.*/
} WVR_TimeWarpStabilizedMode;
 ...
 *
 * Store the lower and upper UV coordinates to specify the region of the submitting texture.
 * The lower-left coordinates are kept in lowerLeftUVs.
 * The upper-right coordinates are kept in upperRightUVs.
 */
typedef struct WVR_TextureLayout {
    WVR_Vector2f leftLowUVs;                               /**< Component 0 and 1 are lower-left UV coordinates of the texture. */
    WVR_Vector2f rightUpUVs;                               /**< Component 0 and 1 are upper-right UV coordinates of the texture. */
} WVR_TextureLayout_t;
 ...
 * The WVR_SubmitFrame need this struct as an argument to pass current texture identity to runtime.
 */
typedef struct WVR_TextureParams {
    ...
    WVR_Texture_t depth;                               /**< Correspond to the name of texture to identify texture entity in graphics library such as OpenGL. */
 ...
 *
 * Aggregate the related texture layers information that needs to be updated to runtime.
 * The texture parameters can be obtained via WVR_GetTexture or directly assigned a valid texture.
 * The WVR_SubmitFrameLayers needs this struct as an argument to pass the current texture identity to runtime.
 */
typedef struct WVR_LayerParams {
    WVR_Eye eye;                                    /**< Eye id to specify the side of the scene. */
    WVR_Texture_t id;                               /**< The name of the texture to identify the texture entity in the graphics library such as OpenGL. */
    WVR_TextureTarget target;                       /**< Specifies the target to which the texture is bound. The parameter corresponds to the texture target in the graphics library such as OpenGL. */
                                                    /**< it must be WVR_TextureTarget_2D if the layer type is WVR_TextureLayerType_Overlay or WVR_TextureLayerType_Underlay */
    WVR_TextureLayout_t layout;                     /**< The lower-left and upper-right UV coordinates pair that specifies the presenting region of the submitted texture. */
    WVR_TextureOptions opts;                        /**< Specify the additional flag of the corresponding texture layer. */
    WVR_TextureShape shape;                         /**< Assign the shape of the texture layer. */
    WVR_TextureLayerType type;                      /**< Specify the type of layer. Only one layer of WVR_TextureLayerType_Content in one frame is allowed. */
    uint32_t compositionDepth;                      /**< Composition order. The smaller value is composited first; the larger value means closer to the eye (0 ~ 15). */
    WVR_PoseState_t* pose;                          /**< The pose used for rendering this frame. */
    WVR_Pose_t* poseTransform;                      /**< Specify the position and orientation of this layer corresponding to the scene. */
    WVR_Vector3f* size;                             /**< The size of this layer, measured in meters. */
    uint32_t width;                                 /**< The texture width. */
    uint32_t height;                                /**< The texture height. */
    float cylinderRadius;                           /**< The radius of the cylinder. */
    WVR_Texture_t depth;                            /**< The name of the texture to identify the texture entity in the graphics library such as OpenGL. */

    WVR_Matrix4f_t *projectionMatrix;               /**< Projection matrix of the content. */
} WVR_LayerParams_t;
 ...
 */
typedef enum {
    WVR_FoveationMode_Disable = 0x0000,           /**< **WVR_FoveationMode_Disable**: Disable foveated rendering. */
    WVR_FoveationMode_Enable  = 0x0001,           /**< **WVR_FoveationMode_Enable**: Enable foveated rendering and using @ref WVR_SetFoveationConfig to set config. */
    WVR_FoveationMode_Default = 0x0002,           /**< **WVR_FoveationMode_Default**: Default config depending on the device. Using @ref WVR_IsRenderFoveationDefaultOn and @ref WVR_GetFoveationDefaultConfig to query details. */
} WVR_FoveationMode;

/**
 * @brief The peripheral region quality that is used in @ref WVR_RenderFoveationParams_t.
 */
typedef enum {
    WVR_PeripheralQuality_Low    = 0x0000,           /**< **WVR_PeripheralQuality_Low**: The peripheral region quality is low while power saved is high. */
    WVR_PeripheralQuality_Medium = 0x0001,           /**< **WVR_PeripheralQuality_Medium**: The peripheral region quality is medium and power saved are average. */
    WVR_PeripheralQuality_High   = 0x0002,           /**< **WVR_PeripheralQuality_High**:  The peripheral region quality is high while power saved is low. */
} WVR_PeripheralQuality;

/**
 * @brief Foveation parameters
 *
 * Aggregate custom information of foveated rendering used in @ref WVR_PreRenderEye.
 */
typedef struct WVR_RenderFoveationParams {
    float focalX;                                    /**< **focalX**: The x coordinate of the focal point in normalized device coordinates. (-1.0 - 1.0) */
    float focalY;                                    /**< **focalY**: The y coordinate of the focal point in normalized device coordinates. (-1.0 - 1.0) */
    float fovealFov;                                 /**< **fovealFov**: The fov of the foveal.*/
    WVR_PeripheralQuality periQuality;               /**< **periQuality**: The peripheral region quality of the foveated rendering. */
...
/**
* @brief Check whether foveated rendering is support.
*
* This function must be called after calling WVR_RenderInit.
*
* @retval true foveated rendering feature is support in runtime.
* @retval false foveated rendering feature is not support  in runtime.
* @version API Level 3
*/
extern WVR_EXPORT bool WVR_IsRenderFoveationSupport();

/**
* @brief Check whether foveated rendering is enabled.
*
* This function must be called after calling WVR_RenderInit.
*
* @retval true Foveated rendering is enabled.
* @retval false Foveated rendering is disabled.
* @version API Level 5
*/
extern WVR_EXPORT bool WVR_IsRenderFoveationEnabled();

/**
* @brief Check whether foveated rendering is enabled or disabled when default mode is used.
*
* This function must be called after calling WVR_RenderInit.
*
* @retval true Foveated rendering is enabled when default mode is used.
* @retval false Fvoeated rendering is disabled when default mode is used.
* @version API Level 5
*/
extern WVR_EXPORT bool WVR_IsRenderFoveationDefaultOn();

/**
* @brief Enable or disable foveated rendering (deprecated).
*
* Deprecated. Using new API @ref WVR_RenderFoveationMode.
* Using to enable or disable foveated rendering.
* And developer need to call @ref WVR_PreRenderEye to take foveated rendering effect on texture.
* This function is platform-depent, must call @ref WVR_IsRenderFoveationSupport to check does this platform support this.
*
* @param enable To enable or diable foveated rendering.
* @version API Level 3
*/
extern WVR_EXPORT void WVR_RenderFoveation(bool enable) WVR_DEPRECATED("");

/**
* @brief Enable or disable foveated rendering or set the default mode for foveated rendering.
*
* @ref WVR_PreRenderEye must be called to apply foveated effect on a texture.
* This function is device dependent. @ref WVR_IsRenderFoveationSupport  must be called to check if the device supports foveated rendering.
* This function must be called after calling WVR_RenderInit.
*
* @param mode Change the foveated rendering mode.
* @retval WVR_Success Mode was successfully changed.
* @retval others Failed to change the mode. See @ref WVR_Result for more information.
* @version API Level 5
*/
extern WVR_EXPORT WVR_Result WVR_RenderFoveationMode(WVR_FoveationMode mode);
...
* @param foveatParam pointer to struct WVR_RenderFoveationParams_t, to aggregate custom informations of foveated rendering. (optional)
* @version API Level 3
*/
...
/**
* @brief Set the foveated rendering config.
*
* Need to be called before WVR_PreRenderEye to let config take place on the same frame.
* This function must be called after calling WVR_RenderInit.
*
* @param eye WVR_Eye, eye id to specify the side of the scene.
* @param foveatedParam Foveated rendering config
* @retval WVR_Success The config was successfully set.
* @retval others Failed to set the config. See @ref WVR_Result for more information.
* @version API Level 5
*/
extern WVR_EXPORT WVR_Result WVR_SetFoveationConfig(const WVR_Eye eye, const WVR_RenderFoveationParams_t *foveatedParam);

/**
* @brief Get the default foveated rendering config of the device.
*
* The default config will vary depending on the device.
* This function must be called after calling WVR_RenderInit.
*
* @param eye WVR_Eye, eye id to specify the side of the scene.
* @param foveatedParam The foveated rendering config
* @retval WVR_Success The config was successfully retrieved.
* @retval others Failed to retrieve config. See @ref WVR_Result for more information.
* @version API Level 5
*/
extern WVR_EXPORT WVR_Result WVR_GetFoveationDefaultConfig(const WVR_Eye eye, WVR_RenderFoveationParams_t *foveatedParam);

/**
* @brief [Experimental feature] Set up AMC mode(OFF/Force_UMC/AUTO/Force_PMC).
*             This function must be called ONCE before WVR_RenderInit to ensure AMC works.
* @param mode AUTO mode is recommanded on CPU bound APP to keep the smoothess, and Force_UMC/PMC mode
              is for debuging, should not be use in release apk. Default mode is Off and mute all AMC
              feature.
* @retval @ref WVR_result
* @version API Level 6
*/
extern WVR_EXPORT WVR_Result WVR_SetAMCMode(const WVR_AMCMode mode);

/**
* @brief Enable the Timewarp Stabilized Mode which will improve the smoothness
*        but may introduce extra latency.
*
* @param mode Target mode.
* @retval WVR_Success Enable or disable this function successfully.
* @retval WVR_Error_FeatureNotSupport Does not support this function in this platform.
* @retval WVR_Error_SystemInvalid The runtime has not been initialized yet.
* @version API Level 6
*/
extern WVR_EXPORT WVR_Result WVR_EnableTimeWarpStabilizedMode(WVR_TimeWarpStabilizedMode mode);

/**
* @brief Get the next predicte display timestamp(ns).
*
* @retval uint64_t Next display system timestamp. return 0 if error occurs or not support.
* @version API Level 6
*/
extern WVR_EXPORT uint64_t WVR_GetPredictedDisplayTime();

/**
 * @brief Update multiple texture layers to display
 *
 * Besides submitting the right and left scenes, developers can submit a frame with separate texture layers and different behavior. Runtime will
 * compose the layers into the final frame.
 *
 * @param param Pointer to struct WVR_LayerParams_t to aggregate texture layers for this frame.
 * @param layerCount Number of layers provided in param.
 * @param extendMethod enum WVR_SubmitExtend. Flag to specify the invoking path.
 * @return WVR_SubmitError. The error status of the WVR_SubmitFrame interface. Refer to @ref WVR_RenderError for the different statuses.
 * @version API Level 6
 */
extern WVR_EXPORT WVR_SubmitError WVR_SubmitFrameLayers(const WVR_LayerParams_t *param, uint32_t layerCount, WVR_SubmitExtend extendMethod = WVR_SubmitExtend_Default);

/**
 * @brief Get the maximum number of multiple texture layers supported.
 *
 * This function must be called after WVR_RenderInit.
 *
 * @retval uint32_t Maximum number (including the content layer) of multiple texture layers supported. Return 1 if the device does not support multiple texture layers.
 * @version API Level 6
 */
extern WVR_EXPORT uint32_t WVR_GetMaxFrameLayerCount();

/**
 * @brief Set frame sharpness enhancement level. This API valid while WVR_RenderConfig_Initialize_FrameSharpnessEnhancement bit is enabled in WVR_RenderConfig while WVR_RenderInit.
 *
 * @param level Valid level range is [0, 1], it is proportional to  content layer's sharpness.
 *
 * @retval @ref WVR_result
 * @version API Level 6
 */
extern WVR_EXPORT WVR_Result WVR_SetFrameSharpnessEnhancementLevel(float level = 0.5);
